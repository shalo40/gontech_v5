<?php namespace App\Http\Controllers;
	...
	class AdminPersonalsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Nombre completo','name'=>'nombre','type'=>'text','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Rut','name'=>'rut','type'=>'text','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Telefono 1','name'=>'telefono_1','type'=>'text','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Telefono 2','name'=>'telefono_2','type'=>'text','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Correo Personal','name'=>'correo_personal','type'=>'email','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Correo Empresa','name'=>'correo_empresa','type'=>'email','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Direccion','name'=>'direccion','type'=>'text','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Especialidad','name'=>'especialidad','type'=>'text','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Area','name'=>'area','type'=>'text','width'=>'col-sm-4'];
			...
			//$this->form[] = ["label"=>"Area","name"=>"area","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
