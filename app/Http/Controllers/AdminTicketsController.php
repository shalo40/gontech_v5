<?php namespace App\Http\Controllers;
	...
	class AdminTicketsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Cliente','name'=>'cliente_id','type'=>'select2','width'=>'col-sm-6','datatable'=>'clientes,nombre_cliente'];
			$this->form[] = ['label'=>'Fecha Hora Asignacion','name'=>'fecha_hora_asignacion','type'=>'datetime','validation'=>'date_format:Y-m-d H:i:s','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Fecha Hora Limite Respuesta','name'=>'fecha_hora_limite_respuesta','type'=>'datetime','validation'=>'date_format:Y-m-d H:i:s','width'=>'col-sm-4'];
			$this->form[] = ['label'=>'Area Del Requerimiento','name'=>'area_del_requerimiento','type'=>'text','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Tipo Servicio','name'=>'tipo_servicio','type'=>'text','width'=>'col-sm-6'];
			...
			$this->form[] = ['label'=>'Descripcion Problema','name'=>'descripcion_problema','type'=>'textarea','width'=>'col-sm-6'];
			$this->form[] = ['label'=>'Responsable del ticket','name'=>'responsable_id','type'=>'select2','width'=>'col-sm-6','datatable'=>'personals,nombre'];
			$this->form[] = ['label'=>'Estado Ticket','name'=>'estado_ticket','type'=>'text','width'=>'col-sm-4'];
			...
			//$this->form[] = ['label'=>'Procedimiento a aplicar','name'=>'procedimiento_id','type'=>'select2','width'=>'col-sm-4','datatable'=>'procedimientos,nombre_procedimiento'];
			//$this->form[] = ['label'=>'Descripcion Problema','name'=>'descripcion_problema','type'=>'textarea','width'=>'col-sm-6'];
			//$this->form[] = ['label'=>'Responsable del ticket','name'=>'responsable_id','type'=>'select2','width'=>'col-sm-6'];
			//$this->form[] = ['label'=>'Estado Ticket','name'=>'estado_ticket','type'=>'text','width'=>'col-sm-4'];
			# OLD END FORM
